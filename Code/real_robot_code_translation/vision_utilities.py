...
matrix_dist_path = os.path.join(home, 'Repositories/test_bed_RL_robot/camera_calibration_files')
...
def calculate_cube_position():
    ...
    if len(corners) > 1:  # if there are at least two ids on the screen
        ...
        return position_cube_cm[0][:-1]  # I am not considering z axis here
